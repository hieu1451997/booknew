...
<head>
    ...
    <link rel="apple-touch-icon" href="front/images/icon.png">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-6 col-lg-2">
                        <div class="logo">
                            <a href="index.html">
                                <img src="front/images/logo/logo.png" alt="logo images">
                            </a>
                        </div>
                    </div>
                                        ...
                                        <div class="single__items">
                                            <div class="miniproduct">
                                                <div class="item01 d-flex">
                                                    <div class="thumb">
                                                        <a href="product-details.html"><img src="front/images/product/sm-img/1.jpg" alt="product images"></a>
                                                    </div>
                                                    <div class="content">
                    ...
                    <div class="product product__style--3">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product__thumb">
                                <a class="first__img" href="single-product.html"><img src="front/images/books/1.jpg" alt="product image"></a>
                                <a class="second__img animation1" href="single-product.html"><img src="front/images/books/2.jpg" alt="product image"></a>
                                <div class="hot__box">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer__widget footer__menu">
                                <div class="ft__logo">
                                    <a href="index.html">
                                        <img src="front/images/logo/3.png" alt="logo">
                                    </a>
